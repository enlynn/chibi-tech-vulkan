...
/// Enable debug reporting from vulkan.
pub const ENABLE_DEBUG_MESSENGER:   bool = true;
...
//std::array<const char*, 1> Device::cValidationLayers = {
//        "VK_LAYER_KHRONOS_validation"
//};
//
//std::array<const char*, 1> Device::cDebugExtensions = {
